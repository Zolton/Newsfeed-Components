...
class Article {
  ...
  expandArticle() {
    ...
    //console.log("funtion = " + this.expandArticle)
...
-XXX Select all classes named ".article" and assign that value to the articles variable.  
...
articles.forEach(classCreator)
function classCreator (domElement) {
